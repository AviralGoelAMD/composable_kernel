...
def get_fwd_appendkv_blobs(arch : str, kernel_filter : Optional[str], receipt, mask_impl) -> Tuple[FmhaFwdAppendKVApiPool, List[FmhaFwdAppendKVKernel]]:
...
def write_blobs(arch : str, output_dir : Path, kernel_filter : Optional[str], receipt, optdim_list, mask_impl) -> None:
    ...
    api_pool, kernels = get_fwd_appendkv_blobs(arch, kernel_filter, receipt, mask_impl)
...
def list_blobs(arch : str, file_path : Path, kernel_filter : Optional[str], receipt, optdim_list, mask_impl) -> None:
    ...
    with file_path.open('a') as f:
        _, kernels = get_fwd_appendkv_blobs(arch, kernel_filter, receipt, mask_impl)
        for kernel in kernels:
