...
run_fp32_tests_1() {
    ...
    $EXE -prec=fp32 -mode=0 -b=64 -h=8 -s=1024 -s_k=1024 -d=48  -iperm=$perm -operm=$perm -vlayout=$vlayout -kname=$KNAME $COMMON_ARGS
    $EXE -prec=fp32 -mode=0 -b=32 -h=8 -s=1024 -s_k=1024 -d=128 -iperm=$perm -operm=$perm -vlayout=$vlayout -kname=$KNAME $COMMON_ARGS
